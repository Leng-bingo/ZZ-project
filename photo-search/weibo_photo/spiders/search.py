...
import scrapy
import weibo_photo.utils.util as util
from scrapy.exceptions import CloseSpider
from scrapy.utils.project import get_project_settings
from weibo_photo.items import WeiboPhotoItem
...
class SearchSpider(scrapy.Spider):
    ...
    # 加入可选参数
    def __init__(self, keyword=None, start=None, end=None, label1=None, label2=None, label3=None, *args, **kwargs):
    ...
    def parse_weibo(self, response):
        ...
        for sel in response.xpath("//div[@class='card-wrap']"):
            ...
            if info:
                ...
                keywords = self.keyword.split(',')
                weibo['item1'] = self.keyword
                weibo['item2'] = self.label2
                weibo['item3'] = self.label3
                # print('asdasdasd', weibo)
