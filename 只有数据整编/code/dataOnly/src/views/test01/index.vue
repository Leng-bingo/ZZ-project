<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="数据库表名" min-width="150px">
        <template slot-scope="{row}">
          <span>{{ row.address }}</span>
        </template>
      </el-table-column>
      <el-table-column label="爬取数量" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.count }}</span>
        </template>
      </el-table-column>
...
import { test_post_method, page_data } from '@/api/mydata'
...
export default {
  ...
  methods: {
    getList() {
      ...
      page_data(this.listQuery).then(response => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          console.log(data)
          test_post_method(data).then((res) => {
