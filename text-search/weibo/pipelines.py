...
# print(city)
city = KEYWORD_LIST[0]
# a = SearchSpider().canshu(1)
# a = SearchSpider().canshu()
...
class MysqlPipeline(object):
    ...
    def create_table(self):
        ...
        sql = """
                ...
                myid int(20) auto_increment NOT NULL,
                ...
                item3 varchar(200),
                PRIMARY KEY (myid)
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4""" % city
    ...
    def process_item(self, item, spider):
        ...
        sql = """INSERT INTO {table}({keys}) VALUES ({values}) ON
                     DUPLICATE KEY UPDATE""".format(table=city,
                                                    keys=keys,
                                                    values=values)
